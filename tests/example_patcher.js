...
//5.
console.log("5.  And the server modifies the state of its object");
...
//6.
console.log("6. The server broadcasts the updated state to all clients sending only delta encoded chunks");
server.broadcastChanges();
server.printState();
console.log("\n\n");
